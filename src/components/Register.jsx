      ...
      <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8 space-y-6">
          ...
          <button
            ...
            disabled={uploading}
            className="w-full bg-gradient-to-r from-purple-600 to-pink-500 text-white py-4 rounded-2xl font-bold text-lg shadow-lg hover:scale-105 transform transition duration-300"
          >
